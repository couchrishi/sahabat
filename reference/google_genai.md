...
- [Google Gen AI SDK](https://googleapis.github.io/python-genai/#)
  ...
  - [Imports](https://googleapis.github.io/python-genai/#imports)
  - [Create a client](https://googleapis.github.io/python-genai/#create-a-client)
    - [API Selection](https://googleapis.github.io/python-genai/#api-selection)
    - [Faster async client option: Aiohttp](https://googleapis.github.io/python-genai/#faster-async-client-option-aiohttp)
    - [Proxy](https://googleapis.github.io/python-genai/#proxy)
    - [Custom base url](https://googleapis.github.io/python-genai/#custom-base-url)
  - [Types](https://googleapis.github.io/python-genai/#types)
- [Models](https://googleapis.github.io/python-genai/#models)
  - [Generate Content](https://googleapis.github.io/python-genai/#generate-content)
    - [with text content](https://googleapis.github.io/python-genai/#with-text-content)
    - [with uploaded file (Gemini Developer API only)](https://googleapis.github.io/python-genai/#with-uploaded-file-gemini-developer-api-only)
    - [How to structure contents argument for generate\_content](https://googleapis.github.io/python-genai/#how-to-structure-contents-argument-for-generate-content)
      - [Provide a list\[types.Content\]](https://googleapis.github.io/python-genai/#provide-a-list-types-content)
      - [Provide a types.Content instance](https://googleapis.github.io/python-genai/#provide-a-types-content-instance)
      - [Provide a string](https://googleapis.github.io/python-genai/#provide-a-string)
      - [Provide a list of string](https://googleapis.github.io/python-genai/#provide-a-list-of-string)
      - [Provide a function call part](https://googleapis.github.io/python-genai/#provide-a-function-call-part)
      - [Provide a list of function call parts](https://googleapis.github.io/python-genai/#provide-a-list-of-function-call-parts)
      - [Provide a non function call part](https://googleapis.github.io/python-genai/#provide-a-non-function-call-part)
      - [Provide a list of non function call parts](https://googleapis.github.io/python-genai/#provide-a-list-of-non-function-call-parts)
      - [Mix types in contents](https://googleapis.github.io/python-genai/#mix-types-in-contents)
  - [System Instructions and Other Configs](https://googleapis.github.io/python-genai/#system-instructions-and-other-configs)
  - [Typed Config](https://googleapis.github.io/python-genai/#typed-config)
  - [List Base Models](https://googleapis.github.io/python-genai/#list-base-models)
    - [List Base Models (Asynchronous)](https://googleapis.github.io/python-genai/#list-base-models-asynchronous)
  - [Safety Settings](https://googleapis.github.io/python-genai/#safety-settings)
  - [Function Calling](https://googleapis.github.io/python-genai/#function-calling)
    - [Disabling automatic function calling](https://googleapis.github.io/python-genai/#disabling-automatic-function-calling)
    - [Manually declare and invoke a function for function calling](https://googleapis.github.io/python-genai/#manually-declare-and-invoke-a-function-for-function-calling)
    - [Function calling with `ANY` tools config mode](https://googleapis.github.io/python-genai/#function-calling-with-any-tools-config-mode)
  - [JSON Response Schema](https://googleapis.github.io/python-genai/#json-response-schema)
    - [Pydantic Model Schema support](https://googleapis.github.io/python-genai/#pydantic-model-schema-support)
  - [Enum Response Schema](https://googleapis.github.io/python-genai/#enum-response-schema)
    - [Text Response](https://googleapis.github.io/python-genai/#text-response)
    - [JSON Response](https://googleapis.github.io/python-genai/#json-response)
  - [Generate Content (Synchronous Streaming)](https://googleapis.github.io/python-genai/#generate-content-synchronous-streaming)
    - [Streaming for text content](https://googleapis.github.io/python-genai/#streaming-for-text-content)
    - [Streaming for image content](https://googleapis.github.io/python-genai/#streaming-for-image-content)
  - [Generate Content (Asynchronous Non-Streaming)](https://googleapis.github.io/python-genai/#generate-content-asynchronous-non-streaming)
  - [Generate Content (Asynchronous Streaming)](https://googleapis.github.io/python-genai/#generate-content-asynchronous-streaming)
  - [Count Tokens and Compute Tokens](https://googleapis.github.io/python-genai/#count-tokens-and-compute-tokens)
    - [Compute Tokens](https://googleapis.github.io/python-genai/#compute-tokens)
    - [Count Tokens (Asynchronous)](https://googleapis.github.io/python-genai/#count-tokens-asynchronous)
  - [Embed Content](https://googleapis.github.io/python-genai/#embed-content)
  - [Imagen](https://googleapis.github.io/python-genai/#imagen)
    - [Generate Image](https://googleapis.github.io/python-genai/#generate-image)
    - [Edit Image](https://googleapis.github.io/python-genai/#edit-image)
  - [Veo](https://googleapis.github.io/python-genai/#veo)
    - [Generate Videos](https://googleapis.github.io/python-genai/#generate-videos)
- [Chats](https://googleapis.github.io/python-genai/#chats)
  - [Send Message (Synchronous Non-Streaming)](https://googleapis.github.io/python-genai/#send-message-synchronous-non-streaming)
  - [Send Message (Synchronous Streaming)](https://googleapis.github.io/python-genai/#send-message-synchronous-streaming)
  - [Send Message (Asynchronous Non-Streaming)](https://googleapis.github.io/python-genai/#send-message-asynchronous-non-streaming)
  - [Send Message (Asynchronous Streaming)](https://googleapis.github.io/python-genai/#send-message-asynchronous-streaming)
- [Files](https://googleapis.github.io/python-genai/#files)
  - [Upload](https://googleapis.github.io/python-genai/#upload)
  - [Get](https://googleapis.github.io/python-genai/#get)
  - [Delete](https://googleapis.github.io/python-genai/#delete)
- [Caches](https://googleapis.github.io/python-genai/#caches)
  - [Create](https://googleapis.github.io/python-genai/#create)
  - [Get](https://googleapis.github.io/python-genai/#id3)
  - [Generate Content with Caches](https://googleapis.github.io/python-genai/#generate-content-with-caches)
- [Tunings](https://googleapis.github.io/python-genai/#tunings)
  - [Tune](https://googleapis.github.io/python-genai/#tune)
  - [Get Tuning Job](https://googleapis.github.io/python-genai/#get-tuning-job)
  - [Use Tuned Model](https://googleapis.github.io/python-genai/#use-tuned-model)
  - [Get Tuned Model](https://googleapis.github.io/python-genai/#get-tuned-model)
  - [Update Tuned Model](https://googleapis.github.io/python-genai/#update-tuned-model)
  - [List Tuned Models](https://googleapis.github.io/python-genai/#list-tuned-models)
    - [List Tuned Models (Asynchronous)](https://googleapis.github.io/python-genai/#list-tuned-models-asynchronous)
  - [Update Tuned Model](https://googleapis.github.io/python-genai/#id4)
  - [List Tuning Jobs](https://googleapis.github.io/python-genai/#list-tuning-jobs)
- [Batch Prediction](https://googleapis.github.io/python-genai/#batch-prediction)
  - [Create](https://googleapis.github.io/python-genai/#id5)
  - [List](https://googleapis.github.io/python-genai/#list)
    - [List Batch Jobs with Pager](https://googleapis.github.io/python-genai/#list-batch-jobs-with-pager)
    - [List Batch Jobs (Asynchronous)](https://googleapis.github.io/python-genai/#list-batch-jobs-asynchronous)
    - [List Batch Jobs with Pager (Asynchronous)](https://googleapis.github.io/python-genai/#list-batch-jobs-with-pager-asynchronous)
  - [Delete](https://googleapis.github.io/python-genai/#id6)
- [Error Handling](https://googleapis.github.io/python-genai/#error-handling)
- [Reference](https://googleapis.github.io/python-genai/#reference)